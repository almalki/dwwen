...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Blog.is_ownership_verified'
        db.add_column(u'api_blog', 'is_ownership_verified',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Blog.is_ownership_verified'
        db.delete_column(u'api_blog', 'is_ownership_verified')
