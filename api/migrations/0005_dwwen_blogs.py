...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Blog.type'
        db.add_column(u'api_blog', 'type',
                      self.gf('django.db.models.fields.SmallIntegerField')(default=1),
                      keep_default=False)


        # Changing field 'Blog.rss_url'
        db.alter_column(u'api_blog', 'rss_url', self.gf('django.db.models.fields.URLField')(max_length=2048, unique=True, null=True))

        # Changing field 'Blog.blog_url'
        db.alter_column(u'api_blog', 'blog_url', self.gf('django.db.models.fields.URLField')(max_length=2048, unique=True, null=True))
        # Adding field 'Post.status'
        db.add_column(u'api_post', 'status',
                      self.gf('django.db.models.fields.SmallIntegerField')(default=2),
                      keep_default=False)


        # Changing field 'Post.link'
        db.alter_column(u'api_post', 'link', self.gf('django.db.models.fields.URLField')(max_length=2048, unique=True, null=True))

    def backwards(self, orm):
        # Deleting field 'Blog.type'
        db.delete_column(u'api_blog', 'type')


        # User chose to not deal with backwards NULL issues for 'Blog.rss_url'
        raise RuntimeError("Cannot reverse this migration. 'Blog.rss_url' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Blog.rss_url'
        db.alter_column(u'api_blog', 'rss_url', self.gf('django.db.models.fields.URLField')(max_length=2048, unique=True))

        # User chose to not deal with backwards NULL issues for 'Blog.blog_url'
        raise RuntimeError("Cannot reverse this migration. 'Blog.blog_url' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Blog.blog_url'
        db.alter_column(u'api_blog', 'blog_url', self.gf('django.db.models.fields.URLField')(max_length=2048, unique=True))
        # Deleting field 'Post.status'
        db.delete_column(u'api_post', 'status')


        # User chose to not deal with backwards NULL issues for 'Post.link'
        raise RuntimeError("Cannot reverse this migration. 'Post.link' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Post.link'
        db.alter_column(u'api_post', 'link', self.gf('django.db.models.fields.URLField')(max_length=2048, unique=True))
