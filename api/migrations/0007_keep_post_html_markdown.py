...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'api_post', 'content_html',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Post.markdown'
        db.add_column(u'api_post', 'markdown',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'api_post', 'content_html')

        # Deleting field 'Post.markdown'
        db.delete_column(u'api_post', 'markdown')
