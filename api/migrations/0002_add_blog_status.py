...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Blog.status'
        db.add_column(u'api_blog', 'status',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


        # Changing field 'Blog.rss_url'
        db.alter_column(u'api_blog', 'rss_url', self.gf('django.db.models.fields.URLField')(unique=True, max_length=2048))

        # Changing field 'Blog.http_etag'
        db.alter_column(u'api_blog', 'http_etag', self.gf('django.db.models.fields.CharField')(max_length=200))

        # Changing field 'Blog.blog_url'
        db.alter_column(u'api_blog', 'blog_url', self.gf('django.db.models.fields.URLField')(unique=True, max_length=2048))

        # Changing field 'Blog.http_last_modified'
        db.alter_column(u'api_blog', 'http_last_modified', self.gf('django.db.models.fields.CharField')(max_length=100))
        # Adding field 'Post.full_content'
        db.add_column(u'api_post', 'full_content',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


        # Changing field 'Post.link'
        db.alter_column(u'api_post', 'link', self.gf('django.db.models.fields.URLField')(unique=True, max_length=2048))

    def backwards(self, orm):
        # Deleting field 'Blog.status'
        db.delete_column(u'api_blog', 'status')


        # Changing field 'Blog.rss_url'
        db.alter_column(u'api_blog', 'rss_url', self.gf('django.db.models.fields.URLField')(max_length=300, unique=True))

        # Changing field 'Blog.http_etag'
        db.alter_column(u'api_blog', 'http_etag', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'Blog.blog_url'
        db.alter_column(u'api_blog', 'blog_url', self.gf('django.db.models.fields.URLField')(max_length=300, unique=True))

        # Changing field 'Blog.http_last_modified'
        db.alter_column(u'api_blog', 'http_last_modified', self.gf('django.db.models.fields.CharField')(max_length=50))
        # Deleting field 'Post.full_content'
        db.delete_column(u'api_post', 'full_content')


        # Changing field 'Post.link'
        db.alter_column(u'api_post', 'link', self.gf('django.db.models.fields.URLField')(max_length=600, unique=True))
